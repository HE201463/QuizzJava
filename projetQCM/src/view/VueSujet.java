...
public class VueSujet extends ProjetVue implements ActionListener, ItemListener{
	...
	//JTextField et JButton Box utilis̩s pour proposer une question
	...
	//JTextField et JButton Box utilis̩s pour ajouter une question
	...
	//La box, les 4 boutons r̩ponses possibles + le JTextField de la question pour le quizz
	private Box quizz;
	...
	public VueSujet(ProjetModel model, ProjetController controller) {
		...
		ajoutQuestion = new JButton("Voir les questions propos̩es");
	...
	/**
	 * Cette m̩thode permet d'afficher l'interface vers les questions
	 */
	@Override
	public void affiche() {	
